...
Usage:
    python hfcli.py browse                     # trending GGUF models
    python hfcli.py search qwen vision         # keyword search
    python hfcli.py info Qwen/Qwen3-VL-8B-GGUF # card + files + quants
    python hfcli.py pull Qwen/Qwen3-VL-8B-GGUF # download (auto-picks quant)
    python hfcli.py pull <repo> --quant Q4_K_M # force a quant
    python hfcli.py list                       # what's on disk
    python hfcli.py eject <repo>               # delete it
"""
