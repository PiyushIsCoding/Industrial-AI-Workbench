...
Setup:
    ...
    .venv/bin/python -m pip install httpx pyyaml

Usage:
    python engine.py enrich                      # fill manifest from README frontmatter
    python engine.py test <repo>                 # spawn, ask a question, kill
    python engine.py test <repo> --image pic.png # vision test
    python engine.py serve <repo>                # spawn and stay up (Ctrl-C to stop)
    python engine.py serve <repo> --port 8081
    python engine.py ps                          # what's running
"""
