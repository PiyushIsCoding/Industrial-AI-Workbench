...
Run:  .venv/bin/python smoke.py           # all checks
      .venv/bin/python smoke.py --quick   # skip the slow model calls
      .venv/bin/python smoke.py --plan "read the report and draft an approval note"
